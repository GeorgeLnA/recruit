          ...
          return (
            ...
            >
              ...
              >
                ...
                <div className="absolute left-full ml-2 px-2 py-0.5 rounded text-xs font-semibold text-white/90 bg-black/50 whitespace-nowrap transition-opacity duration-300">
                  {pin.name}
                </div>
              </button>
